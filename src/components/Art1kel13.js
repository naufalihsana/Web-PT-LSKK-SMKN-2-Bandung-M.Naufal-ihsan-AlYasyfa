...
const Artkl13 = () => {
    ...
    <div className='pt-32 pl-10 pb-16  ' >
        <div>
            <h1 className='pl-52 text-[35px]'>WATER LEVEL FLOAT </h1>
        </div>
        <div className="grid-cols-2 grid w-[40%] ml-52 gap-2">
          <img src={alat13} alt=""  className="w-[100%]"/>
                <p className="w-[250%] text-justify text-[17px]"> 
                <span className='text-blue-900 font-bold text-[20px]'> Water Level Float </span> adalah perangkat pendeteksi level cairan dan cairan lain serta padatan terfluidisasi, termasuk sluri, bahan granular, dan bubuk yang menunjukkan permukaan bebas bagian atas. Zat yang mengalir pada dasarnya menjadi horizontal dalam wadahnya (atau batas fisik lainnya) karena gravitasi sedangkan sebagian besar padatan curah bertumpuk pada sudut istirahat ke puncak. Substansi yang akan diukur dapat berada di dalam wadah atau dapat dalam bentuk aslinya (misalnya sungai atau danau). Pengukuran level dapat berupa nilai kontinu atau titik.  
                </p>
  ...
  border-gray-600 transition"
      >
        <div className="flex leading-5">
          ...
          <a href="/artikel12" className='text-gray-700'>
          Back</a>
        </div>
      </button>
