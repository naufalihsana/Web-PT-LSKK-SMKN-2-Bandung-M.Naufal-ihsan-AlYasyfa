...
const Artkl4 = () => {
  ...
  border-gray-600 transition"
      ...
      >
        <div className="flex leading-5">
          <a href="/artikel4" className='text-teal-700 '> 4</a>
      ...
      >
        <div className="flex leading-5">
        <a href="/artikel5" className='text-blue-700 '> 5</a>
