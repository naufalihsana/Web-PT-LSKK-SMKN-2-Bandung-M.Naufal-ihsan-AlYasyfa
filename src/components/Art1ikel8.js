import alat8 from '../assets/alat3.jpg'
...
const Artkl8 = () => {
  ...
  border-gray-600 transition"
      ...
      >
        <div className="flex leading-5">
        <a href="/artikel9" className='text-blue-700 '> 9</a>
