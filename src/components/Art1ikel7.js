...
const Artkl7 = () => {
    ...
    <div className='pt-32 pl-10 pb-16  ' >
        <div>
            <h1 className='pl-52 text-[35px]'>SMART PARKING </h1>
        </div>
        <div className="grid-cols-2 grid w-[40%] ml-52 gap-2">
          <img src={alat7} alt=""  className="w-[100%]"/>
                <p className="w-[250%] text-justify text-[17px]"> 
                <span className='text-blue-900 font-bold text-[20px]'> Smart Parking </span> adalah perangkat yang digunakan untuk sensor suatu hal yang apabila digunakan sensor  tersebut akan berbunyi dan bunyi nya itu seperti suara lonceng.
  ...
  border-gray-600 transition"
      ...
      >
        <div className="flex leading-5">
          <a href="/artikel7" className='text-teal-700 '> 7</a>
      ...
      >
        <div className="flex leading-5">
        <a href="/artikel8" className='text-blue-700 '> 8</a>
