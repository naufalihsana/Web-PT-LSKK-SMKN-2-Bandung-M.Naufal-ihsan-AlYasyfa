...
const Artkl11 = () => {
    ...
    <div className='pt-32 pl-10 pb-16  ' >
        <div>
            <h1 className='pl-52 text-[35px]'>SOIL MOISTURE </h1>
        </div>
        <div className="grid-cols-2 grid w-[40%] ml-52 gap-2">
          <img src={alat11} alt=""  className="w-[100%]"/>
                <p className="w-[250%] text-justify text-[17px]"> 
                <span className='text-blue-900 font-bold text-[20px]'> Soil Moisture </span> adalah perangkat mengukur kadar air volumetrik dalam tanah.[1] Karena pengukuran gravimetrik langsung dari kelembaban tanah bebas membutuhkan pemindahan, pengeringan, dan penimbangan sampel, sensor kelembaban tanah mengukur kandungan air volumetrik secara tidak langsung dengan menggunakan beberapa sifat tanah lainnya, seperti hambatan listrik, konstanta dielektrik, atau interaksi dengan neutron. , sebagai proxy untuk kadar air.
  ...
  border-gray-600 transition"
      >
        <div className="flex leading-5">
          ...
          <a href="/artikel10" className='text-gray-700'>
          Back</a>
        </div>
      </button>
      ...
      >
        <div className="flex leading-5">
          <a href="/artikel11" className='text-teal-700 '> 11</a>
      ...
      >
        <div className="flex leading-5">
        <a href="/artikel12" className='text-blue-700 '> 12</a>
