...
const Artkl5 = () => {
    ...
    <div className='pt-32 pl-10 pb-16  ' >
        <div>
            <h1 className='pl-52 text-[35px]'>HOME AUTO STECKER </h1>
        </div>
        <div className="grid-cols-2 grid w-[40%] ml-52 gap-2">
          <img src={alat3} alt=""  className="w-[100%]"/>
                <p className="w-[250%] text-justify text-[17px]"> 
                <span className='text-blue-900 font-bold text-[20px]'>HOME AUTO STECKER</span> adalah sistem otomatis untuk memarkir mobil, dan secara efektif merupakan tempat parkir mobil bertingkat otomatis, menggunakan kombinasi ban berjalan, lift, dan boneka untuk memindahkan kendaraan dari permukaan tanah ke salah satu dari 256 tempat parkir mobil
  ...
  border-gray-600 transition"
      ...
      >
        <div className="flex leading-5">
          <a href="/artikel5" className='text-teal-700 '> 5</a>
      ...
      >
        <div className="flex leading-5">
        <a href="/artikel6" className='text-blue-700 '> 6</a>
      ...
      >
        <div className="flex leading-5">
        <a href="/arikel7" className='text-teal-700 '> 7</a>
      ...
      >
        <div className="flex leading-5">
        <a href="/artikel6" className='text-gray-700'>
          Next</a>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="100%"
