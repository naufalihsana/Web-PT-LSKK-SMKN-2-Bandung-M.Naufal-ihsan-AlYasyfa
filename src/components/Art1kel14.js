...
const Artkl14 = () => {
    ...
    <div className='pt-32 pl-10 pb-16  ' >
        <div>
            <h1 className='pl-52 text-[35px]'>HOME AUTO WATER PUMP </h1>
        </div>
        <div className="grid-cols-2 grid w-[40%] ml-52 gap-2">
          <img src={alat14} alt=""  className="w-[100%]"/>
                <p className="w-[250%] text-justify text-[17px]"> 
                <span className='text-blue-900 font-bold text-[20px]'> Home Auto Water Pump</span> adalah sebuah alat yang dapat digunakan untuk mencegah banjir. Perangkat ini dirancang untuk menanggapi kondisi air yang meningkat. Ketika air mencapai tingkat yang telah ditentukan, itu melengkapi sirkuit. Ini menyebabkan pompa pintar beroperasi. Saat level air turun, sirkuit 'putus' dan pompa berhenti.
            Dalam aplikasi rumah tangga, sistem pemompaan bah pintar adalah sistem yang menggunakan teknologi WiFi untuk mengirim pesan peringatan saat kondisi banjir memungkinkan. Mereka juga dapat menyampaikan pesan tentang kondisi pompa jika tidak berfungsi.
  ...
  border-gray-600 transition"
      ...
      >
        <div className="flex leading-5">
        <a href="/artikel15" className='text-gray-700'>
          Next</a>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="100%"
