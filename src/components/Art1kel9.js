...
const Artkl9 = () => {
    ...
    <div className='pt-32 pl-10 pb-16  ' >
        ...
        <div className="grid-cols-2 grid w-[40%] ml-52 gap-2">
          <img src={alat9} alt=""  className="w-[100%]"/>
                <p className="w-[250%] text-justify text-[17px]"> 
                <span className='text-blue-900 font-bold text-[20px]'> Smart Watering </span> adalah prototipe sistem perawatan tanaman secara otomatis, dimana sistem monitoringnya dirancang melalui Web Perancangan prototipe ini dimaksudkan untuk membantu pengontrolan sistem perawatan tanaman berjenis tomat pada tingkat perorangan (personal user).
  ...
  border-gray-600 transition"
      >
        <div className="flex leading-5">
          ...
          <a href="/artikel8" className='text-gray-700'>
          Back</a>
        </div>
      </button>
      ...
      >
        <div className="flex leading-5">
          <a href="/artikel9" className='text-teal-700 '> 9</a>
      ...
      >
        <div className="flex leading-5">
        <a href="/artikel10" className='text-blue-700 '> 10</a>
